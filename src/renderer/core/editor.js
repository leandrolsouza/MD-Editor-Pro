...
const HtmlToMarkdownConverter = require('../features/html-to-markdown');
            ...
            extensions: [
                ...
                EditorView.updateListener.of((update) => {
                    if (update.docChanged) {
                        ...
                        // Emit event bus event alongside existing callbacks
                        eventBus.emit('editor:content-changed', { content });
                    }
                    if (update.selectionSet || update.docChanged) {
                        ...
                        // Compute line and column from offset and emit event
                        const lineInfo = update.state.doc.lineAt(offset);
                        const line = lineInfo.number;
                        const col = offset - lineInfo.from + 1;
                        eventBus.emit('editor:cursor-changed', { line, col });
                    }
                }),
