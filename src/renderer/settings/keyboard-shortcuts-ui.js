...
class KeyboardShortcutsUI {
    ...
    async loadShortcuts() {
        try {
            ...
            notificationManager.error(`Error loading shortcuts: ${error.message}`);
        }
    }
    ...
    async setShortcut(actionId, keyBinding) {
        try {
            ...
            console.error('Error setting shortcut:', error);
            notificationManager.error(`Error setting shortcut: ${error.message}`);
        } finally {
            this.cancelRecording();
        }
    }
    ...
    async resetShortcut(actionId) {
        try {
            ...
            notificationManager.error(`Error resetting shortcut: ${error.message}`);
        }
    }
    ...
    async resetAll() {
        ...
        try {
            ...
            notificationManager.error(`Error resetting all shortcuts: ${error.message}`);
        }
    }
